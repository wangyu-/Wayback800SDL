...
extern uint64_t *current_cycle_ptr;
const uint32_t BEEPER_AUDIO_HZ = 44100;
const uint32_t CYCLES_SECOND=spdc1016freq;
const uint32_t int_inf=1000*1000*1000;
...
void manipulate_beeper(int a){
    long long current_cycle=*current_cycle_ptr;//nc1020_states.previous_cycles+nc1020_states.cycles;
